...
const CollectionSSSS =()=>{
    ...
    return(
        ...
        className={top ? 'hidden lg:flex xl:w-[85%] xl:mx-[7.5%] w-full absolute bg-[#F8F7F5] left-0 overflow-auto top-[68px] z-[50]' : 'hidden h-[85vh] lg:flex xl:w-[85%] xl:mx-[7.5%] w-full absolute bg-[#F8F7F5] left-0 top-[114px] z-[50]'}>
