...
const TopSellerBox = () => {
  ...
  return (
    <div className='w-[100%] h-[300px] sm:h-[350px] md:pl-6 sm:pl-4 pl-2'>
        ...
        <div className='flex flex-col overflow-auto -10 topSellersBar mx-1'>
          <Slider className='-10' {...settings} > 
            {
              data.map((item,index)=>{
                return(
                  <div href='' className='w-auto hover:z-[99999] h-[300px] sm:h-[300px] relative'>
