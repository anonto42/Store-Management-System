...
const ProductCart = ({item}) => {
  ...
  return (
    <Link to='/product/xyz'>
        <div className=' w-[460px] sm:w-[540px] md:w-[700px] mt-5 h-[350px] lg:mx-6 lg:w-[350px] lg:h-[280px] hover:scale-105 hover:shadow-md duration-100 ease-in border-2 bg-white rounded-lg pb-2'>
