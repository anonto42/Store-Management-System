...
const NarltemAfterLg =()=>{
    const {Materials , setMaterials} = useContext(myContext)
    return(
        <> 
            <div onMouseLeave={()=>{setMaterials(false)}}  
        onMouseEnter={()=> setMaterials(true) } className='hidden lg:flex xl:w-[85%] xl:mx-[7.5%] w-full absolute bottom-0 bg-[#F8F7F5] left-0 h-[] top-[21.4vh] z-[999]'>
