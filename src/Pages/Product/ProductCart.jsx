    ...
    <div className='w-full h-auto'>
      ...
      <div className='mt-16'>
        <div className=' md:w-[30%]'>
          ...
          <h2 className='flex justify-center underline italic font-light my-4'>Question & Answers ({'7'})</h2>
          <div className='flex justify-center'>
            <div className='w-[90%] flex text-white text-2xl font-bold cursor-pointer hover:bg-[#1a924e] justify-center items-center h-[60px] bg-[#008338]'>ORDER NOW</div>
          </div>
        </div>
        {/* lllkkk kkkk */}
        <div>
          <h1 className='flex ml-8 text-sm font-bold mb-3 mt-8'>Sticker type:</h1>
          <div className='flex justify-center '>
          ...
          <div className='flex justify-center my-9'>
            <button className='w-[420px] h-[70px] bg-green-700 flex justify-center items-center text-xl font-bold text-white'>ORDER NOW</button>
          </div>
        </div>
